...
readme_content = """# 🌙 Sleep Nutrients Project
...
if __name__ == "__main__":
    ...
    with open("README.md", "w", encoding="utf-8") as f:
        f.write(readme_content.format(out1=out1, out2=out2, out_cross=out_cross, out3=out3, out4=out4))
    print("README.md updated with TOC, separators, and file links!")
